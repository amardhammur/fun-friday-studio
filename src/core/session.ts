...
const schema = z.object({
  formatVersion: z.literal(1), id: z.string(), title: z.string(), activityId: z.string(), activityVersion: z.number().int().positive(), createdAt: z.string(), updatedAt: z.string(), isDemo: z.boolean(), phase: z.enum(['setup', 'play', 'finale']), setupStepId: z.string(),
  ...
  scoreEntries: z.array(z.object({ id: z.string(), teamId: z.string(), roundId: z.string().optional(), kind: z.enum(['round-award', 'manual-adjustment']), points: z.number().int(), active: z.boolean() })),
